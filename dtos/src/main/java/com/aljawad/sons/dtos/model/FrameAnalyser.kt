 ...
 */
package com.aljawad.sons.dtos.model
...
import com.aljawad.sons.dtos.utils.BoundingBoxOverlay
import com.aljawad.sons.dtos.utils.Logger
import com.aljawad.sons.dtos.utils.Prediction
...
class FrameAnalyser(
    ...
    private var onImageDetected: (String) -> Unit
    ...
    var faceList = mutableListOf<Pair<String, FloatArray>>()
...
//                        if (bestScoreUserName != "Unknown") {
                        onImageDetected.invoke(bestScoreUserName)
